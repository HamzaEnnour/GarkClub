    ...
    this._auth.register(this.userCredentials).subscribe(
      (res) => {
        ...
        if (res["created"] == false) {
          ...
          this.notifications.create('Succès', "L'utilisateur est bien crée, un lien de confimation a été envoyé", NotificationType.Bare, { theClass: 'outline primary', timeOut: 6000, showProgressBar: false });
          setTimeout(()=>{
